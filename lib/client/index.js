...
module.exports = function(env) {
	...
	return function() {
		...
		_self.searchManagedObjects  = require('./searchManagedObjects')(env);
		 ...
		 * Constructor
		 */
		return function(host, user, password, ignoreSSL, maxRetry, exclusive) {
			...
			_self.exclusive = (typeof(exclusive) === 'boolean') ? exclusive : false;
			_self.host      = host;
			_self.user      = user;
