...
module.exports = function(env) {
	...
	var Client = function(args) {
		...
		_client.getTypes              = require('./getTypes')(env);
		_client.errorHandler          = require('./errorHandler')(env);
		_client.method                = require('./method')(env);
		_client.propertySpec          = require('./propertySpec')(env);
		...
		_client.emitUpdates           = require('./emitUpdates')(env);
		...
		_client.findParentType        = require('./findParentType')(env);
